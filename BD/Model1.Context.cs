...
namespace pen_clothes.BD
{
    ...
    public partial class pen_clothesEntities : DbContext
    {
        public pen_clothesEntities()
            : base("name=pen_clothesEntities")
        {
        }
        ...
        public virtual DbSet<GetMaterial> GetMaterial { get; set; }
